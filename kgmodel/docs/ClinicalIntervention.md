...
![img](http://yuml.me/diagram/nofunky;dir:TB/class/\[ClinicalIntervention|id(i):identifier_type;name(i):label_type;category(i):iri_type%20%2B]^-\[Medication],%20\[ClinicalEntity]^-\[ClinicalIntervention])
